...
#if defined(DOCTEST_PLATFORM_LINUX) or defined(DOCTEST_PLATFORM_ESP)
...
#elif defined(DOCTEST_PLATFORM_ESP)
    struct SignalDefs
    {
        int         id;
        const char* name;
    ...
    struct ConsoleReporter : public IReporter
    {
        ...
        void test_run_end(const TestRunStats& p) override {
            ...
            s << Color::Cyan << "[doctest] " << Color::None
              ...
              << "\n\n"
              << p.numTestCasesPassingFilters << " Tests " << p.numTestCasesFailed <<  " Failures "  << p.numTestCases - p.numTestCasesPassingFilters << " Ignored" 
              << "\n\n";
        }
